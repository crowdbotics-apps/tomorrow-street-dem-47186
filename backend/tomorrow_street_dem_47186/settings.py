"""
Django settings for tomorrow_street_dem_47186 project.
...
ROOT_URLCONF = 'tomorrow_street_dem_47186.urls'
...
WSGI_APPLICATION = 'tomorrow_street_dem_47186.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tomorrow_street_dem_47186 API",
    "DESCRIPTION": "API documentation for tomorrow_street_dem_47186 App",
    "VERSION": "v1",
}
